// Hybrid: Non-centered random effects + Centered x imputation
// Best for: Small N (weakly-identified RE) with well-observed x
data {
...
parameters {
  ...
  // Centered missing x values (directly parameterized)
  vector[G_mis] x_mis;
}
...
model {
  ...
  // Imputation model likelihood (all x - observed informs params, missing gets sampled)
