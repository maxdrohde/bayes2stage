################################################################################
# Fit one design for the credible regions analysis (negative-binomial imputation)
#
...
# Use schildcrout spec but override to negative-binomial imputation
SPEC <- MODEL_SPECS$schildcrout
SPEC$imp_distribution <- "negative_binomial"
...
cli::cli_h1("Fitting design: {design_name} (negative-binomial)")
