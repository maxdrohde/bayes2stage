################################################################################
# Fit one design for the credible regions analysis
#
...
#   Contains posterior draws for beta_x and beta_x_t_interaction,
#   plus diagnostics columns.
#
...
cli::cli_h1("Fitting design: {design_name}")
