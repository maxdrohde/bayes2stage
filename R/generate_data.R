generate_data <-
  function(N = 1000,
           M = 5,
           alpha_main = 1, beta_x = 2, beta_z = 0.5, beta_t = 2, beta_t_xe_interaction = 1,
           error_sd = 1, error_type = "normal",
           rand_intercept_sd = 3, rand_slope_sd = 3, rand_eff_corr = 0.4,
           gamma0 = 1, gamma1 = 0, gamma2 = 2, gamma_sd = 1) {
